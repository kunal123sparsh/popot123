        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">CC CHECKER</h6>
            ...
            <div class="widget-list row">
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg.transparent">
                        <div class="widget-heading">
                            <h5 class="widget-title"><center><b>Response-Tab</b></center></h5>
                            <br>
                        ...
                        <div class="widget-body">
                            <button type="button" id="sh_apr" onclick="Mudaestado('aprovadasapp');" class="btn btn-outline-success">APPROVED [ <span id="aprovada_conta">0</span> ]</button>
                            ...
                            <button type="button" id="sh_ccn" onclick="Mudaestado('ccnapp');" class="btn btn-outline-teal">CCN [ <span id="ccn_conta">0</span> ]</button>
                ...
                <div class="widget-holder widget-full-content widget-full-height col-lg-6">
                    <div class="widget-bg.transparent">
                        <div class="widget-heading">
                            <h5 class="widget-title"><center><b>CC-Input</b></center></h5>
                            <div class="widget-graph-info">
                                <div class="dropdown"><a href="javascript:void(0)" class="dropdown-toggle text-muted fs-16" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#">Action</a>  <a class="dropdown-item" href="#">Another action</a>  <a class="dropdown-item" href="#">Something else here</a>
                                    </div>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <textarea id="lista" placeholder="FORMAT: 0000000000000000|00|0000|000" class="form-control" style="resize:none;outline:none;width:100%; height:150px;"></textarea><br>

                                    <button type="button" id="iniciar" onclick="start()" class="btn btn-outline-success">Start</button> <button type="button" onclick="stop()" id="parar" class="btn btn-outline-danger">Stop</button>

                                    <br><br>

                                    <small>STATUS: <span class="badge badge-pill badge-primary" id="demo">Let's do it!</span>
                                    <br>
                                    APPROVED: <span id="CLIVE" class="badge badge-success">0</span> -
                                    CCN: <span id="CCN" class="badge badge-teal">0</span> -
